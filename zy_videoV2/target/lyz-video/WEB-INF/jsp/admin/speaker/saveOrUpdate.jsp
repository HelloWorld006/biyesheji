...
<form class="form-horizontal" enctype="multipart/form-data" action="admin/speaker/saveOrUpdate.do" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="file" name="speaker" id="speakerHeadUrl" accept="image/png,image/jpeg,image/jpg"  placeholder="主讲人头像地址，网络图片">
    </div>
  </div>
  <div class="form-group">
    <label for="speakerDescr" class="col-sm-2 control-label">简介</label>
    <div class="col-sm-10">
      <textarea class="form-control" name="speakerDescr" id="speakerDescr" rows="3">${speaker.speakerDescr }</textarea>
    </div>
  </div>
  <div class="form-group">
